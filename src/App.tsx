...
function App() {
  ...
  return (
    <div style={{ width: "100%", background: "#000000", minHeight: "100vh",position:"relative" }}>
      <img src="/3.jpg" width={400} style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-70%)"}}/>
      {!authinicated && <Login />}
      ...
      {authinicated && (
        <ClippyProvider agentName={AGENTS.CLIPPY}>
          <div className="fixed">
            ...
            <DesktopIcon width={650} icon={<FileFont variant="32x32_4"/>} name="suɐld ǝɹnʇnɟ">
             <FuturePlans/>
            </DesktopIcon>
          </div>
